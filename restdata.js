...
firebase.firestore().doc("stid/"+'{{wf {&quot;path&quot;:&quot;name&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}')
.set({stid:'{{wf {&quot;path&quot;:&quot;name&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}'}, {merge:true})

let curUser = firebase.auth().currentUser;
let myFS = firebase.firestore()
let docRef = myFS.doc("stid/" + '{{wf {&quot;path&quot;:&quot;name&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}')
docRef.get().then(docSnap => {
let data = docSnap.data()
let staff = data['staffcount'];
let ftb = data['ftbcount'];
let sec = data['seccount'];
let wbw = data['wbwcount'];
let dlv = data['dlvcount'];

if(!!staff){
document.querySelector('#staffcount1').textContent = staff
document.querySelector('#staffcount2').textContent = staff
document.querySelector('#staffcount3').textContent = staff
}
if(!!ftb){
document.querySelector('#ftbcount').textContent = ftb
}
if(!!sec){
document.querySelector('#seccount').textContent = sec
}
if(!!wbw){
document.querySelector('#wbwcount').textContent = wbw
}
})
}
