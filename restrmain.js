...
document.querySelector('#grossmtd').textContent =(formatToCurrency( Number($('#grossmtd').text())))
document.querySelector('#grosslastmonth').textContent =(formatToCurrency( Number($('#grosslastmonth').text())))
document.querySelector('#grossalltime').textContent =(formatToCurrency( Number($('#grossalltime').text())))
}
