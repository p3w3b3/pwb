...
document.querySelector('#mystid').textContent = datastid
        ...
        if (course1 || course2 || course3 || course4 || course5 || course6 || course7 || course8 || course9 || course10 || course11 || course12) {
          $("#n3").show();
          $("#trainingmob").show();
        } else {
          $("#n3").hide();
...
$('#rrx033').hide()
    ...
    if (
      "https://stonegate.peckwaterbrands.com/dashboard#contact" === currentPath2
    ) {
      $("#homebox").hide();
      $(".ob-box").hide();
      $("#obsidebar").hide();
      ...
      "https://stonegate.peckwaterbrands.com/dashboard#onboarding" ===
      currentPath2
    ) {
      $("#homebox").hide();
      $(".ob-box").hide();
      ...
      "https://stonegate.peckwaterbrands.com/dashboard#onboarding1" ===
      currentPath2
    ) {
      $("#homebox").hide();
      $(".ob-box").hide();
      ...
      "https://stonegate.peckwaterbrands.com/#onboarding2" === currentPath2
    ) {
      $("#homebox").hide();
      $(".ob-box").hide();
      $("#ob2").show();
      ...
      "https://stonegate.peckwaterbrands.com/dashboard#tracking" ===
      currentPath2
    ) {
      $("#homebox").hide();
      $(".ob-box").hide();
