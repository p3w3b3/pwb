Webflow.push(function() {Webflow.push(function() {
...
} else if('https://www.peckwaterbrands.com/dashboard#onboarding1' === currentPath){
$('#homebox').hide()
$('.ob-box').hide()
$('#obsidebar').show()
$('#ob1').show()
...
$(".nav-button").css("border-color","transparent");
$("#n2").css("border-color","white");
} else if('https://www.peckwaterbrands.com/dashboard#onboarding2' === currentPath){
$('#homebox').hide()
$('.ob-box').hide()
$('#ob2').show()
$('#contactbox').hide()
